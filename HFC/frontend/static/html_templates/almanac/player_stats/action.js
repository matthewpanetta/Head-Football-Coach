        ...
        /*
          ...
          "columns": [
            {"data": "player_team_season.team_season.team.school_name", "sortable": false, 'className': 'column-shrink', 'searchable': true,"fnCreatedCell": function (td, StringValue, player, iRow, iCol) {
              ...
              {"data": "player_team_season.games.game_score", "sortable": true, 'orderSequence':["desc"], 'className': 'col-group', "fnCreatedCell": function (td, game_score, player, iRow, iCol) {
                  $(td).html(round_decimal(game_score, 0));
              }},
              {"data": "player_team_season.passing.yards", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              ...
              {"data": "player_team_season.passing.tds", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.passing.ints", "sortable": true, 'visible': false,'className': 'col-group', 'orderSequence':["desc"]},

              {"data": "player_team_season.rushing.yards", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              ...
              {"data": "player_team_season.rushing.tds", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.rushing.lng", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.rushing.over_20", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.fumbles.fumbles", "sortable": true, 'visible': false,'className': 'col-group',  'orderSequence':["desc"]},

              {"data": "player_team_season.receiving.yards", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.receiving.receptions", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              ...
              {"data": "player_team_season.receiving.tds", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.receiving.targets", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.receiving.lng", "sortable": true, 'visible': false,'className': 'col-group',  'orderSequence':["desc"]},

              {"data": "player_team_season.defense.tackles", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.defense.tackles_for_loss", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.defense.sacks", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.defense.ints", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.defense.deflections", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.fumbles.forced", "sortable": true, 'visible': false, 'orderSequence':["desc"]},
              {"data": "player_team_season.fumbles.recovered", "sortable": true, 'visible': false,'className': 'col-group',  'orderSequence':["desc"]},
