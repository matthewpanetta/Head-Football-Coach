    ...
    const getHtml = async (common) => {
      ...
      var filter_url = '/static/html_templates/team/roster/player_table_filter_template.html'
      ...
      var column_control_url = '/static/html_templates/team/roster/player_table_column_control_template.html'
      ...
      const add_column_control_listeners = async (common) => {
       ...
       const add_table_listeners = async (common) => {
        ...
        const GetPlayerStats = async (common) => {
          ...
          var url = '/static/html_templates/team/roster/player_table_template.html'
