...
(function ($) {
    ...
    function trackHighlighter(teamIndex, cssClass, container) {
        ...
        var teamColor = elements.first().attr('data-teamcolor');
        var addedClass = !cssClass ? "highlight" : cssClass;
        return {
            highlight: function () {
                elements.each(function () {
                  console.log('on highlight',$(this));
                    $(this).addClass(addedClass);

                    $(this).css('backgroundColor', teamColor);
    ...
    function postProcess(container, w, f) {
        ...
        if (winner && loser) {
            if (!winner.name.isEmpty()) {
                ...
                console.log('postprocess', winner, source, w,f)
            }
            if (!loser.name.isEmpty()) {
                trackHighlighter(loser.seed.get(), "highlightLoser", container).highlight();
                trackHighlighter(loser.seed.get(), "highlightLoser", container).deHighlight();
            }
        }
    ...
    function teamElement(roundNumber, match, team, opponent, isReady, isFirstBracket, opts, resultId, topCon, renderAll, gameColor, gameID) {
        ...
        tEl.attr('data-teamcolor', gameColor); //TODO
        tEl.attr('data-gameid', gameID); //TODO
    ...
    var Match = /** @class */ (function () {
        ...
        Match.prototype.render = function () {
            ...
            this.teamCon.append(teamElement(this.round.roundNumber, this.match, this.match.a, this.match.b, isReady, this.isFirstBracket, this.opts, this.resultId, this.topCon, this.renderAll, this.matchUserData.HomeColor, this.matchUserData.GameID));
            this.teamCon.append(teamElement(this.round.roundNumber, this.match, this.match.b, this.match.a, isReady, this.isFirstBracket, this.opts, this.resultId, this.topCon, this.renderAll, this.matchUserData.AwayColor, this.matchUserData.GameID));
