  ...
  */
  ...
  for (var i=1; i < 128; i++) {
    ...
    if (i in teams) {
      ...
      var link = '/Game/'+game.GameID;
      if ((i % 2 == 1) && (game.round < 7)) {
        ...
        link = '/Team/'+game.teamid;
      }
      console.log(i, game.round, tooltipText);
